var MoveUtils = /** @class */ (function () {
     ...
     */
    MoveUtils.move = function (board, direction, moveInfo) {
    ...
    MoveUtils.moveDirection = function (squares, up, moveInfo) {
    ...
    MoveUtils.condenseBlanks = function (squares, up, moveInfo) {
        if (squares.length > 1) {
            if (up) {
                var prevSquareIndex = -1;
    ...
    MoveUtils.moveAll = function (squares, up) {
        if (up) {
            // start from top
